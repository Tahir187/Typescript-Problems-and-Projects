  ...
  if (opponent.opponentName == "Red Skull") {
    ...
    if (ask.opt === "Attack") {
      ...
      if (num > 0) {
        o1.healthDecrease();
        console.log(
          chalk.bold.red(`${o1.opponentName} health is ${o1.health}`)
        );
        console.log(
          chalk.bold.green(`${p1.playerName} health is ${p1.health}`)
        );
        if(o1.health <= 0){
      ...
      if (num <= 0) {
        ...
        console.log(
          chalk.bold.green(`${o1.opponentName} health is ${o1.health}`)
        );
        if(p1.health <= 0){
